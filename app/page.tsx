        ...
        <div className="min-h-screen relative overflow-hidden">
            ...
            <main className="relative flex flex-col items-center justify-center px-6 py-24 text-center min-h-screen">
                <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-7xl mx-auto">
                    {/* 1. Logo Badge with Corner Brackets */}
                    <motion.div
                    ...
                    <motion.h1
                        ...
                        className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tight leading-none mb-12"
                    >
                        <span className="text-gradient">animatAI</span>
                    </motion.h1>

                    {/* 3. Component Categories Section (Carousel) */}
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    {/* Feature Cards (Kept at bottom as likely desired) */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-24 w-full max-w-6xl">
                        {[
                            {
                                icon: Zap,
                                title: 'GSAP Mastery',
